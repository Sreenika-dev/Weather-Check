This is a web application that displays the weather information for a user's current location or any other location searched by the user. It was built using React JS and the OpenWeatherMap API.
